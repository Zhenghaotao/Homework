package gdufs.gdufsplayer.widget;
...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    private static final int STATE_IDLE               = 0;//加载缓冲状态
    ...
    private static final int STATE_PAUSED             = 4;//停播状态
    private static final int STATE_PLAYBACK_COMPLETED = 5;//播放完毕
    private static final int STATE_SUSPEND            = 6;//播放挂起状态
    private static final int STATE_RESUME             = 7;//播放继续状态
    private static final int STATE_SUSPEND_UNSUPPORTED = 8;//播放无法支持挂起状态( 直播之类的 )
    ...
    private void openVideo() {
        ...
        // TODO: these constants need to be published somewhere in the framework.广播停止正在播放的视频
