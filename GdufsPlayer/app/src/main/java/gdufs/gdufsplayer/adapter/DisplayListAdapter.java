package gdufs.gdufsplayer.adapter;
...
public class DisplayListAdapter extends BaseAdapter {
    ...
    private List<VideoListFragment.VideoWorkItem> mItemList = new ArrayList<VideoListFragment.VideoWorkItem>();
    ...
    public void setListItems(List<VideoListFragment.VideoWorkItem> list) {
        mItemList = list;
    }
...
//        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.localvideo_item, null);
    ...
    public class ViewHolder {
        ...
        public VideoListFragment.VideoWorkItem mItem;
        ...
        public ViewHolder(View convertView) {
            mThumbnail = (ImageView)convertView.findViewById(R.id.iv_thumbnail);
//            mStopFlag = (ImageView)convertView.findViewById(R.id.video_stop);
            ...
            mSize = (TextView)convertView.findViewById(R.id.tv_size);
...
//            mStopFlag.setVisibility(View.GONE);
        ...
        public void refresh(int pos) {
            ...
            if (LocalVideoUtil.THUMBNAIL_PREPARED == mItem.object.getThumbnailState()) {
                /**hejn, optimizing thumbnail list, 20101210 begin*/
//                if (mBitmap != null)
//                    mBitmap.recycle();
            ...
            String displayName = (LocalVideoUtil.isLandscape(((Activity)mContext)) ?
                    LocalVideoUtil.cutString(mItem.name, HModeTitleLength)
                    : LocalVideoUtil.cutString(mItem.name, VModeTitleLength) );
